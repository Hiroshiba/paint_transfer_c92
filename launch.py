...
base_command_default = \
    ...
    "screen -S {project/name}_gpu{train/gpu} -X stuff 'python3 {python_file_path} {recipe_path}\n'"

parser = argparse.ArgumentParser()
parser.add_argument('python_file_path', default='train.py')
parser.add_argument('recipe_json_path', default='recipe/sample.json')
parser.add_argument('--base_config_json_path', default='./paint_transfer/config/base.json')
...
base_config['project']['tags'].append('git branch name:' + git_branch)
base_config['project']['tags'].append('recipe name:' + os.path.basename(args.recipe_json_path))
